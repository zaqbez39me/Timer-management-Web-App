...
async def verify_refresh_token(token: str, db: AsyncSession) -> TokenData | bool:
    return await verify_token(db, RefreshTokenDB, token, jwt_authenticator.get_refresh_token_data)
